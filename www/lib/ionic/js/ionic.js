  ...
  __initEventHandlers: function() {
    ...
    self.scrollChildIntoView = function(e) {
      ...
      if ( e.detail.isElementUnderKeyboard ) {
        var delay;
        // Wait on android for web views to resize
        ...
        //Wait for android to update views height and resize() to reset scroll position
        ...
        setTimeout(function(){
          ...
          scrollBottomOffsetToTop = container.getBoundingClientRect().bottom;
          //distance from top of focused element to the bottom of the scroll views
