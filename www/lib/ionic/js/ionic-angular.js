 ...
 *           'home-tab': {
 *             prefetchTemplate: false,
 *             templateUrl: "tabs-templates/man.html",
    ...
    create: function(navViewCtrl, viewLocals, enteringView, leavingView) {
      ...
      var switcher = {
        ...
        render: function(registerData, callback) {
          // disconnect the leaving scope before reconnecting or creating a scope for the entering views
 ...
 * ### Alternative Usage
 *
 * Alternatively, you may put ion-nav-bar inside of each individual views's ion-views element.
 * This will allow you to have the whole navbar, not just its contents, transition every views change.
 *
 * This is similar to using a header bar inside your ion-views, except it will have all the power of a navbar.
 *
 * If you do this, simply put nav buttons inside the navbar itself; do not use `<ion-nav-buttons>`.
 *
 *
 * ```html
 * <ion-views views-title="myTitle">
 *   <ion-nav-bar class="bar-positive">
 *     <ion-nav-back-button>
 *     </ion-nav-back-button>
 ...
 * and then try to load man.html into the `<ion-nav-views>`.
 *
 * Pages are loaded by the URLs given. One simple way to create templates in Angular is to put
 * them directly into your HTML file and use the `<script type="text/ng-template">` syntax.
 * So here is one way to put man.html into our app:
 *
 * ```html
 ...
 * views changed in {@link ionic.directive:ionicConfig}, in the views's `$state` configuration, or
